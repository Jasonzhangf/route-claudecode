...
export class ScenarioManager extends EventEmitter {
    ...
    async loadAvailableScenarios() {
        ...
        try {
            ...
            console.log(`📊 Loaded ${this.scenarios.size} scenarios successfully`);
    ...
    async createDefaultScenarios() {
        ...
        const defaultScenarios = [
            {
                name: 'full-replay',
                description: 'Complete replay of all recorded data',
                dataFilters: {},
            ...
            {
                name: 'anthropic-only',
                description: 'Replay only Anthropic provider requests',
            ...
            {
                name: 'recent-24h',
                description: 'Replay requests from last 24 hours',
                dataFilters: {},
            ...
            {
                name: 'fast-replay',
                description: 'High-speed replay for load testing',
                dataFilters: {},
                replayOptions: { 
