...
export class DataReplayInfrastructure extends EventEmitter {
    constructor(config = {}) {
        ...
        console.log('📊 Data Replay Infrastructure initialized');
    }
    ...
    async serveDataFromDatabase(request) {
        ...
        try {
            ...
            this.emit('dataServed', { request, dataFiles: dataFiles.length, cached: false });
    ...
    async indexAvailableData() {
        console.log('🔍 Indexing available data...');
        ...
        console.log(`📊 Data index complete: ${this.dataIndex.sessions.length} sessions, ${this.dataIndex.layers.length} layer records`);
    }
    ...
    async buildDataMappings() {
        ...
        console.log('✅ Data mappings built successfully');
    }
