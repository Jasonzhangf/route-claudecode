...
export class ProviderFactory {
  ...
  private createdProviders: Map<string, BaseModule>;
   ...
   * 创建Provider实例
   */
  public createProvider(options: ProviderCreateOptions): BaseModule {
   ...
   * 批量创建Provider实例
   */
  public createProviders(configs: ProviderConfig[], debug: boolean = false): BaseModule[] {
    const providers: BaseModule[] = [];
   ...
   * 获取已创建的Provider
   */
  public getProvider(id: string): BaseModule | undefined {
   ...
   * 获取所有已创建的Provider
   */
  public getAllProviders(): BaseModule[] {
