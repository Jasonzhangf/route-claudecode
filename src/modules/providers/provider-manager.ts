...
export class ProviderManager {
  ...
  private providers: Map<string, BaseModule>;
   ...
   * 注册Provider
   */
  public async registerProvider(provider: BaseModule): Promise<void> {
   ...
   * 应用路由策略
   */
  private applyRoutingStrategy(providers: [string, BaseModule][]): [string, BaseModule] {
   ...
   * 检查Provider兼容性
   */
  private isProviderCompatible(provider: BaseModule, request: StandardRequest): boolean {
   ...
   * 获取Provider类型
   */
  private getProviderType(provider: BaseModule): ProviderProtocolType {
