...
export class MockupDataExtractor {
    databasePath;
    outputFormat;
    constructor(databasePath = '~/.route-claude-code/database', outputFormat = 'json') {
        this.databasePath = databasePath;
        this.outputFormat = outputFormat;
        console.log('🔧 MOCKUP: DataExtractor initialized - placeholder implementation');
    }
    async extractProviderMetrics(provider, timeRange) {
